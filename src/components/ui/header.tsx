          ...
          <div className="flex-1 md:w-auto flex justify-center">
            <div className="relative w-full max-w-md md:max-w-xl">
              <div
                ...
                className={cn(
                  "relative bg-background border border-border z-20",
              ...
              >
                <div className="overflow-hidden">
                    <div className={cn(
                      "bg-background rounded-b-[30px] shadow-lg border border-t-0 border-border pt-2 pb-4 max-h-[60vh] overflow-y-auto"
                    )}>
                        {props.brands && (
                            <Filters
                                brands={props.brands}
